...
public partial class github_commit
{
    ...
    [NotMapped]
    public string CommitSha { get => commit_sha; set => commit_sha = value; }
    [NotMapped]
    public long RepoId { get => repo_id; set => repo_id = value; }
    [NotMapped]
    public DateTime? CommittedAt { get => committed_at; set => committed_at = value; }
}
