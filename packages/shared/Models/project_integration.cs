...
public partial class project_integration
{
    ...
    // Aliases
    [NotMapped]
    public long? JiraProjectId { get => jira_project_id; set => jira_project_id = value; }
    [NotMapped]
    public long? GithubRepoId { get => github_repo_id; set => github_repo_id = value; }
    [NotMapped]
    public string ApprovalStatus { get => approval_status; set => approval_status = value; }
}
