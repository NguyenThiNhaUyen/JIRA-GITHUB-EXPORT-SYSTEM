...
namespace JiraGithubExport.Shared.Migrations
{
    ...
    [Migration("20260326181704_AddAcceptanceCriteriaAndPreconditionsToJiraIssues")]
    partial class AddAcceptanceCriteriaAndPreconditionsToJiraIssues
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JiraGithubExport.Shared.Models.jira_issue", b =>
                {
                    ...
                    b.Property<string>("acceptance_criteria")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("JiraGithubExport.Shared.Models.notification", b =>
                {
                    ...
                    b.Property<long>("recipient_user_id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("JiraGithubExport.Shared.Models.project_integration", b =>
                {
                    ...
                    b.Property<string>("github_token")
                        .HasColumnType("text");

                    b.Property<long?>("jira_project_id")
                        .HasColumnType("bigint");

                    b.Property<string>("jira_token")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("JiraGithubExport.Shared.Models.team_invitation", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("JiraGithubExport.Shared.Models.notification", b =>
                {
                    b.HasOne("JiraGithubExport.Shared.Models.user", "recipient_user")
                        .WithMany()
                        .HasForeignKey("recipient_user_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("JiraGithubExport.Shared.Models.project_document", b =>
                {
                    ...
                    b.HasOne("JiraGithubExport.Shared.Models.user", "reviewer_user")
                        .WithMany()
            ...
            modelBuilder.Entity("JiraGithubExport.Shared.Models.team_invitation", b =>
                {
                    b.HasOne("JiraGithubExport.Shared.Models.user", "invited_by_user")
                        .WithMany()
                        .HasForeignKey("invited_by_userid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JiraGithubExport.Shared.Models.student", "invited_student_user")
                        .WithMany()
