...
namespace JiraGithubExportSystem.Shared.Migrations
{
    ...
    [Migration("20260319065312_FixProjectIntegrationMappings")]
    partial class FixProjectIntegrationMappings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JiraGithubExportSystem.Shared.Models.team_invitation", b =>
                {
                    ...
                    b.HasKey("id")
                        .HasName("team_invitations_pkey");

                    b.HasIndex("invited_by_user_id");

                    b.HasIndex("invited_student_user_id");
            ...
            modelBuilder.Entity("JiraGithubExportSystem.Shared.Models.team_invitation", b =>
                {
                    ...
                    b.HasOne("JiraGithubExportSystem.Shared.Models.student", "invited_student_user")
                        .WithMany()
                        .HasForeignKey("invited_student_user_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
