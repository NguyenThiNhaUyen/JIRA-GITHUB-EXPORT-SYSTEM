...
export function ProjectKpiSidebar({ metrics, isSyncing }) {
 ...
 <h4 className="text-[12px] font-black text-gray-300 tracking-[0.4em] mb-12 relative flex items-center justify-between">
 ...
 <span className="text-[11px] font-black text-teal-600 tracking-[0.2em] bg-teal-50 px-4 py-1.5 rounded-full border border-teal-100 shadow-sm">Total Commits</span>
 ...
 <div className="p-8 rounded-[40px] bg-gray-50/50 border border-gray-100 flex flex-col gap-6 group/item hover:bg-white hover:shadow-2xl transition-all hover:-translate-y-2">
 <div className="flex justify-between items-center">
 <span className="text-[11px] font-black text-indigo-600 tracking-[0.2em] bg-indigo-50 px-4 py-1.5 rounded-full border border-indigo-100 shadow-sm">Merged PRs</span>
