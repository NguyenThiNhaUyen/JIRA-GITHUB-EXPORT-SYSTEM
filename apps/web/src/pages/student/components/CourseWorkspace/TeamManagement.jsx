            ...
            <CardHeader className="p-12 border-b border-gray-50 bg-gray-50/20 flex flex-row items-center justify-between">
                ...
                {isLeader && (
                    <Button 
                        ...
                        variant="ghost" 
                        className="h-14 px-10 rounded-[28px] text-[11px] font-black uppercase tracking-[0.2em] text-emerald-600 hover:bg-emerald-50 hover:text-emerald-700 transition-all font-display hover:scale-105 active:scale-95 border-2 border-emerald-50"
                    >
                    ...
                    {groupStudents.map((m, idx) => (
                        <div key={m.studentId} className="p-12 flex items-center justify-between hover:bg-gray-50/40 transition-all group animate-in slide-in-from-bottom-2 duration-500" style={{ animationDelay: `${idx * 100}ms` }}>
                            <div className="flex items-center gap-8">
                                ...
                                <div>
                                    <p className="font-black text-gray-800 text-lg uppercase tracking-tight leading-none mb-3 font-display">{m.name}</p>
                                    <p className="text-[11px] text-gray-400 font-black uppercase tracking-[0.3em] flex items-center gap-4 opacity-70">
