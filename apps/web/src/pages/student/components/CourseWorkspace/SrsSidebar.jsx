...
export function SrsSidebar({ groupSrs = [], loadingSrs, onSrsCenterNavigate }) {
 ...
 <h4 className="text-[12px] font-black text-teal-500 tracking-[0.4em] mb-12 relative flex items-center gap-4">
 ...
 <p className="text-sm font-black font-display">{srs.fileName || `Version ${srs.version ||"Alpha"}`}</p>
 <div className="flex items-center gap-3">
 <div className="w-1 h-1 rounded-full bg-teal-500 animate-pulse" />
 <p className="text-[10px] font-bold text-teal-500 opacity-80">Updated recently</p>
 </div>
 </div>
 </div>
 ...
 className="w-full h-20 bg-teal-500 hover:bg-teal-400 text-white rounded-[32px] text-[12px] font-black tracking-[0.4em] transition-all border-0 shadow-2xl shadow-teal-500/20 active:scale-95 relative z-10 font-display group/manage overflow-hidden"
 >
