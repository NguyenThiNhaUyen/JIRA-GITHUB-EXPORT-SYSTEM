...
export function InviteMemberModal({ isOpen, onClose, enrolledData, groupStudents, inviteSelectedIds, setInviteSelectedIds, isInviting, onInviteSubmit }) {
 ...
 <div>
 <p className="text-lg font-black text-gray-800 tracking-tight leading-none mb-2 font-display">{s.name}</p>
 <div className="flex items-center gap-3">
 <p className="text-[11px] text-gray-400 font-bold bg-white/50 px-3 py-1 rounded-xl border border-gray-100 group-hover:border-teal-200 group-hover:text-teal-600 transition-colors">{s.studentCode || s.email}</p>
