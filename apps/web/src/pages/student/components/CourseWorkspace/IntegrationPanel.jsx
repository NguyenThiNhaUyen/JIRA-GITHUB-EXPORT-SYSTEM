    ...
    return (
        <Card className="border-0 shadow-[0_40px_80px_-20px_rgba(15,23,42,0.08)] rounded-[48px] bg-white overflow-hidden glass-card">
            <CardHeader className="p-12 border-b border-gray-50 bg-gray-50/20 flex flex-row items-center justify-between">
                <CardTitle className="text-lg font-black text-gray-800 uppercase tracking-[0.2em] flex items-center gap-6 font-display">
            ...
            <CardContent className="p-14 space-y-14">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div className="space-y-5 group/input">
                        <label className="text-[11px] font-black text-gray-400 uppercase tracking-[0.3em] ml-4 flex items-center gap-2">
                        ...
                        <div className="relative">
                            ...
                            <input 
                                disabled={!isLeader}
                                className="w-full h-20 pl-20 pr-10 bg-gray-50 border border-gray-100 rounded-[32px] text-base font-black text-gray-700 focus:bg-white focus:border-teal-500 focus:ring-8 focus:ring-teal-500/10 transition-all outline-none uppercase tracking-widest placeholder:text-gray-200 placeholder:font-bold font-mono group-hover/input:border-teal-200"
                ...
                {isLeader && (
                    <div className="pt-10 border-t border-gray-50 flex justify-end">
                        <Button 
                            ...
                            disabled={isLinking}
                            className="bg-slate-900 hover:bg-black text-white rounded-[32px] h-20 px-16 text-[12px] font-black uppercase tracking-[0.3em] shadow-[0_30px_60px_-10px_rgba(0,0,0,0.1)] transition-all active:scale-95 disabled:opacity-50 border-0 group/save hover:scale-[1.02] font-display"
                        >
