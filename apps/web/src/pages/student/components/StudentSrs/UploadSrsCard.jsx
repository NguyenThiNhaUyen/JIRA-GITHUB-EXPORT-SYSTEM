    ...
    return (
        <Card className="rounded-[52px] border-0 bg-slate-900 text-white p-14 shadow-2xl shadow-indigo-200 group overflow-hidden relative animate-in slide-in-from-right-8 duration-1000">
            ...
            <div className="relative z-10 space-y-12">
                ...
                <div>
                     <h4 className="text-3xl font-black uppercase tracking-tighter mb-6 font-display leading-tight">Hoàn tất tài liệu đặc tả SRS?</h4>
                     <p className="text-[12px] text-teal-200/80 font-black leading-relaxed mb-12 uppercase tracking-widest italic opacity-80">
                ...
                <Button 
                    className="w-full h-20 bg-white text-slate-900 hover:bg-teal-50 rounded-[32px] font-black uppercase tracking-[0.4em] text-[13px] border-0 shadow-2xl transition-all hover:scale-[1.03] active:scale-95 group/btn relative overflow-hidden font-display"
                    onClick={onOpenModal}
                >
