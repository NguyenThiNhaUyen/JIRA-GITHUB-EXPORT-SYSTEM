    ...
    return (
        <Card className="rounded-[48px] border border-gray-100 bg-white p-12 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.05)] glass-card group hover:shadow-2xl transition-all duration-700">
            <div className="flex items-center gap-6 mb-12">
                ...
                <div>
                     <h4 className="font-black text-gray-800 uppercase tracking-[0.2em] text-sm font-display leading-tight mb-1">Thư viện Biểu mẫu</h4>
                     <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Tài nguyên học thuật SRS</p>
                </div>
            </div>
            <ul className="space-y-8">
                <li className="flex items-center justify-between group/item cursor-pointer bg-gray-50/50 p-6 rounded-[28px] hover:bg-white hover:border-indigo-100 border border-transparent transition-all hover:shadow-xl hover:shadow-indigo-500/5 hover:-translate-y-1">
                    <div className="flex flex-col gap-1.5 min-w-0 pr-4">
                         <span className="text-[11px] font-black uppercase tracking-[0.1em] text-gray-800 group-hover/item:text-indigo-600 transition-colors truncate">IEEE Standard 29148-2018 (.PDF)</span>
                         <span className="text-[9px] text-gray-400 font-bold uppercase tracking-widest opacity-60">Software Requirements Guide</span>
                    </div>
                ...
                <li className="flex items-center justify-between group/item cursor-pointer bg-gray-50/50 p-6 rounded-[28px] hover:bg-white hover:border-teal-100 border border-transparent transition-all hover:shadow-xl hover:shadow-teal-500/5 hover:-translate-y-1 opacity-60 hover:opacity-100">
                    <div className="flex flex-col gap-1.5 min-w-0 pr-4">
                         <span className="text-[11px] font-black uppercase tracking-[0.1em] text-gray-800 group-hover/item:text-teal-600 transition-colors truncate">Software Requirements Spec (.DOCX)</span>
                         <span className="text-[9px] text-gray-400 font-bold uppercase tracking-widest opacity-60">Ready-to-use Template</span>
                    </div>
