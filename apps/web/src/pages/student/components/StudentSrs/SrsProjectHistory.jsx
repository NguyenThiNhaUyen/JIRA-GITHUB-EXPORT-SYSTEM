...
export function SrsProjectHistory({ project, index }) {
 ...
 <span className="text-[11px] font-black text-teal-700">{srsList.length} PHIÊN BẢN</span>
 </div>
 </div>
 </CardHeader>
 ...
 <p className="text-[11px] font-black text-gray-300 tracking-[0.3em] italic opacity-60">Dự án chưa có bản nộp đặc tả nào</p>
 </div>
 ) : srsList.map((rpt, idx) => (
 ...
 <p className="text-[10px] font-black text-indigo-400 opacity-80">Phản hồi từ Giảng viên:</p>
 </div>
