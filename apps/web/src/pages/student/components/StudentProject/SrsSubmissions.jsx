...
export function SrsSubmissions({ loadingSrs, srsReports, onUploadModalOpen }) {
 ...
 <CardTitle className="text-xs font-black text-gray-400 font-display">Báº£n ná»™p tĂ i liá»‡u SRS (Software Requirements Specification)</CardTitle>
 ...
 <p className="text-[11px] font-black text-gray-300">Äang táº£i tĂ i liá»‡u...</p>
 </div>
 ) : srsReports.length === 0 ? (
 ...
 <p className="text-[11px] font-black text-gray-400 tracking-[0.3em] leading-relaxed">ChÆ°a cĂ³ tĂ i liá»‡u nĂ o Ä‘Æ°á»£c ná»™p.<br/>PhĂ¢n loáº¡i SRS lĂ  báº¯t buá»™c Ä‘á»ƒ giáº£ng viĂªn duyá»‡t.</p>
 </div>
 ) : (
 ...
 ÄĂ£ ná»™p: {new Date(rpt.submittedAt).toLocaleString("vi-VN")}
 </p>
 ...
 <p className="text-[11px] font-black text-indigo-400 mb-2 opacity-60">Pháº£n há»“i tá»« giáº£ng viĂªn</p>
 ...
 >
 <Download size={18} className="mr-3"/> Táº£i xuá»‘ng
 </Button>
