        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="border border-gray-100 shadow-sm rounded-[44px] overflow-hidden bg-white glass-card">
                <CardHeader className="border-b border-gray-50/50 py-8 px-10 bg-gray-50/10">
                    <CardTitle className="text-xs font-black text-gray-400 uppercase tracking-widest font-display">Phân bổ đóng góp thành viên</CardTitle>
                </CardHeader>
                <CardContent className="p-10">
                    ...
                    <div className="flex justify-center gap-10 mt-8">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none">Commits</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <div className="w-4 h-4 rounded-full bg-indigo-600 shadow-lg shadow-indigo-100 animate-pulse"></div>
                            <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none">Issues</span>
                        </div>
                    </div>
                </CardContent>
            </Card>
            ...
            <Card className="border border-gray-100 shadow-sm rounded-[44px] overflow-hidden bg-white glass-card">
                <CardHeader className="border-b border-gray-50/50 py-8 px-10 bg-gray-50/10">
                    <CardTitle className="text-xs font-black text-gray-400 uppercase tracking-widest font-display">Tần suất commit dự án</CardTitle>
                </CardHeader>
                <CardContent className="p-10">
                    <div className="h-72 w-full">
                        <ResponsiveContainer width="100%" height="100%">
                    ...
                    <p className="text-center text-[10px] font-black text-gray-300 uppercase tracking-[0.3em] mt-8 opacity-60">Dữ liệu 15 ngày gần nhất</p>
                </CardContent>
            </Card>
        </div>
    );
