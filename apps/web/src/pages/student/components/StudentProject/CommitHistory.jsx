            ...
            <CardContent className="p-0">
                {loadingCommits ? (
                    <div className="py-32 text-center space-y-4">
                        ...
                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest animate-pulse">Đang tải lịch sử Git...</p>
                    </div>
                ) : myCommits.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-32 gap-6">
                        ...
                        <p className="text-[10px] font-black text-gray-300 uppercase tracking-widest text-center leading-relaxed">Chưa có bản ghi commit nào<br/>được ghi nhận cho tài khoản này</p>
                    </div>
                ) : (
                            ...
                            <div key={commit.id || commit.sha} className="p-8 px-12 hover:bg-gray-50/50 transition-all flex items-center justify-between group relative overflow-hidden">
                                ...
                                <div className="flex items-center gap-8 min-w-0 relative z-10">
                                    ...
                                    <div className="min-w-0">
                                        <p className="text-base font-black text-gray-800 leading-tight truncate group-hover:text-teal-600 transition-colors uppercase tracking-tight font-display">{commit.message}</p>
