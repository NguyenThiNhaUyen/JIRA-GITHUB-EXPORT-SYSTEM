...
export function ProjectProgress({ cycleTime, metrics, roadmapData, agingWip, cfdData }) {
 ...
 <span className="text-[11px] font-black text-gray-400 mb-1.5">NgĂ y</span>
 </div>
 <p className="text-[10px] text-gray-300 font-bold mt-4 tracking-[0.2em] ml-2">Gáº§n 30 ngĂ y qua</p>
 </Card>
 
 <Card className="border border-gray-100 shadow-sm rounded-[36px] bg-white p-8 relative overflow-hidden group">
 <div className="absolute top-0 left-0 w-2 h-full bg-indigo-500 transition-all group-hover:w-4" />
 <p className="text-[10px] font-black text-gray-400 mb-6 ml-2">Tá»‘c Ä‘á»™ hoĂ n thĂ nh</p>
 <div className="flex items-end gap-3 ml-2">
 ...
 <span className="text-[11px] font-black text-gray-400 mb-1.5">Issues / Tuáº§n</span>
 </div>
 ...
 <span className="text-[11px] font-black text-gray-400 mb-1.5">Äang trá»…</span>
 </div>
 <p className="text-[10px] text-gray-300 font-bold mt-4 tracking-[0.2em] ml-2">Cáº§n táº­p trung xá»­ lĂ½</p>
 </Card>
 </div>
 ...
 <span>30 ngĂ y trÆ°á»›c</span>
 <span>TĂ¬nh tráº¡ng hiá»‡n táº¡i</span>
 </div>
 </div>
 ) : (
 <div className="text-center space-y-4">
 <Clock size={40} className="text-gray-100 mx-auto" />
 <p className="text-[11px] font-black text-gray-300">Dá»¯ liá»‡u CFD Ä‘ang Ä‘Æ°á»£c cáº­p nháº­t...</p>
 </div>
 )}
 </div>
 </CardContent>
 ...
 <Card className="border border-gray-100 shadow-sm rounded-[44px] overflow-hidden bg-white">
 <CardHeader className="border-b border-gray-50/50 py-10 px-12 bg-gray-50/10">
 <CardTitle className="text-xs font-black text-gray-400 font-display">Aging WIP - CĂ´ng viá»‡c tá»“n Ä‘á»ng</CardTitle>
 </CardHeader>
 ...
 <span className="text-[11px] text-gray-400 font-bold bg-gray-100 px-3 py-1 rounded-full border border-gray-50">Tá»“n táº¡i {task.ageDays} ngĂ y</span>
 ...
 <p className="text-[11px] font-black text-gray-300 leading-relaxed">Tuyá»‡t vá»i! KhĂ´ng cĂ³ cĂ´ng viá»‡c nĂ o<br/>bá»‹ tá»“n Ä‘á»ng quĂ¡ thá»i gian quy Ä‘á»‹nh</p>
 </div>
 )}
 </CardContent>
 </Card>
