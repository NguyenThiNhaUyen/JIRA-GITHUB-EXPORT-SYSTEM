            ...
            <CardContent className="p-12">
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                        <div>
                            <div className="flex items-center gap-4 mb-10 text-[10px] font-black text-gray-400 uppercase tracking-widest opacity-60">
                                ...
                                {(commitActivity || Array(7).fill({count: 0})).map((item, i) => {
                                    ...
                                    return (
                                        <div key={i} className="flex-1 flex flex-col items-center gap-4 group/bar">
                                            ...
                                            <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest">{item?.label || `D${i + 1}`}</span>
                                        </div>
                                    );
                                })}
                            </div>
                        ...
                        <div className="flex flex-col justify-center border-l border-gray-100 md:pl-16">
                            ...
                            <div className="flex justify-between items-center text-[10px] font-black text-gray-400 uppercase tracking-[0.3em] bg-gray-50/50 p-4 rounded-2xl border border-gray-100">
