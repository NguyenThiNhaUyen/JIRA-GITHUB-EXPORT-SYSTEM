...
export function MyCoursesGrid({ isLoading, courses, onCourseNavigate, onSeeAll }) {
 ...
 <CardTitle className="text-lg font-black text-gray-800 tracking-[0.2em] font-display">Lớp học của tôi</CardTitle>
 <Button 
 variant="ghost" 
 ...
 <p className="text-[11px] font-black text-gray-300 tracking-[0.4em] leading-relaxed">Bạn chưa đăng ký tham gia khóa học nào</p>
 </div>
 )}
 </CardContent>
 </Card>
