...
export function ProjectContributionList({ projects }) {
 ...
 <h3 className="text-xs font-black text-gray-400 tracking-[0.4em] ml-6 flex items-center gap-4">
 ...
 <h4 className="text-2xl font-black text-gray-800 tracking-tighter group-hover:text-teal-600 transition-colors truncate font-display grow">{p.name}</h4>
 ...
 <p className="text-[10px] font-black text-gray-300 mb-3 opacity-60 group-hover/metric:text-teal-500 transition-colors">Commits</p>
 <p className="font-black text-4xl text-teal-600 tracking-tighter leading-none">{p.commits || 0}</p>
 </div>
 <div className="text-center group/metric">
 <p className="text-[10px] font-black text-gray-300 mb-3 opacity-60 group-hover/metric:text-indigo-500 transition-colors">Issues</p>
 <p className="font-black text-4xl text-indigo-500 tracking-tighter leading-none">{p.issuesDone || 0}</p>
 </div>
 <div className="text-center group/metric">
 <p className="text-[10px] font-black text-gray-300 mb-3 opacity-60 group-hover/metric:text-amber-500 transition-colors">Impact</p>
 <p className="font-black text-2xl text-amber-500 tracking-tight leading-none pt-2 font-display">High</p>
 </div>
 </div>
 </div>
