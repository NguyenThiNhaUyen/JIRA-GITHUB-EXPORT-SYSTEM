...
export function PerformanceRadarCard({ performanceRadar, stats }) {
 ...
 <CardTitle className="text-[11px] font-black text-gray-400 mb-10 flex items-center gap-4">
 ...
 <PolarAngleAxis dataKey="subject" tick={{ fill: '#64748b', fontSize: 10, fontWeight: 900, textTransform: '', letterSpacing: '0.1em' }} />
 <Radar
 name="Skill Index"
 dataKey="A"
 stroke="#6366f1"
