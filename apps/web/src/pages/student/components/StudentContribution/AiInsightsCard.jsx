...
export function AiInsightsCard({ stats }) {
 ...
 <Badge className="bg-white/10 text-teal-400 border-white/5 px-6 py-2 rounded-full font-black tracking-[0.3em] text-[10px] shadow-inner flex items-center gap-3">
 ...
 <h4 className="text-3xl font-black tracking-tighter leading-tight font-display mb-6 group-hover:text-teal-400 transition-colors">AI Performance Insights</h4>
