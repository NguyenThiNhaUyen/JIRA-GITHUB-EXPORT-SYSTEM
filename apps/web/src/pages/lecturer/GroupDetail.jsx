        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <Tabs defaultValue="overview" className="space-y-8">
                <TabsList className="bg-transparent border-0 p-0 flex gap-4 h-auto">
                    <TabsTrigger value="overview" className="h-12 px-8 rounded-2xl text-[10px] font-black uppercase tracking-widest border-0 data-[state=active]:bg-teal-600 data-[state=active]:text-white data-[state=inactive]:bg-gray-100 data-[state=inactive]:text-gray-400 transition-all shadow-sm">
                        Tổng quan & Thành viên
                    </TabsTrigger>
                    <TabsTrigger value="analytics" className="h-12 px-8 rounded-2xl text-[10px] font-black uppercase tracking-widest border-0 data-[state=active]:bg-indigo-600 data-[state=active]:text-white data-[state=inactive]:bg-gray-100 data-[state=inactive]:text-gray-400 transition-all shadow-sm">
