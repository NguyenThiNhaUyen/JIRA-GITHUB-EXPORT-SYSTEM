...
export function GroupExport({
 ...
 <div>
 <h4 className="font-black text-gray-800 text-[10px] mb-1.5">Xuất báo cáo SRS</h4>
 <p className="text-[11px] text-gray-400 font-bold opacity-80">Xuất dữ liệu Jira/GitHub sang PDF chuẩn ISO 29148.</p>
 </div>
 <Button
 ...
 <div className="flex items-center justify-between gap-6">
 <div>
 <h4 className="font-black text-gray-800 text-[10px] mb-1.5">Danh sách Thành viên</h4>
 <p className="text-[11px] text-gray-400 font-bold opacity-80">Xuất bảng điểm đóng góp của nhóm sang định dạng CSV.</p>
 </div>
 <Button
