            ...
            <div className="divide-y divide-gray-50">
              {visibleGroups.length === 0 ? (
                <div className="py-24 text-center bg-gray-50/10">
                  ...
                  <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Không tìm thấy dữ liệu phù hợp</p>
                </div>
                ...
                <div key={group.id} className="p-10 hover:bg-teal-50/5 transition-all duration-500 group/item relative overflow-hidden">
                  ...
                  <div className="flex flex-col xl:flex-row items-start justify-between gap-8 mb-8 relative z-10">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 text-[11px] font-black text-gray-400 uppercase tracking-widest bg-gray-50 w-fit px-3 py-1 rounded-full group-hover/item:bg-white transition-colors border border-gray-100">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10 relative z-10">
                    <MetricCard label="Thành viên" value={`${group.memberCount} SV`} icon={Users} color="teal">
                        <button 
                          ...
                          className="mt-2 text-[8px] font-black uppercase tracking-widest text-teal-600 bg-teal-50 hover:bg-teal-100 px-3 py-1 rounded-lg border border-teal-100 transition-all"
                        >
                          + Thêm
                        </button>
                    </MetricCard>
                  ...
                  <div className="space-y-6 relative z-10">
                    <div className="flex flex-wrap gap-2 pt-2">
                       {(group.team || []).map((member, idx) => (
                        <div key={member.studentUserId || member.studentId || idx} className="flex items-center gap-2.5 px-4 py-2 bg-white border border-gray-100 rounded-2xl text-[10px] font-black text-gray-700 uppercase tracking-tight shadow-sm hover:border-teal-200 hover:shadow-md transition-all cursor-default">
                    ...
                    <div className="space-y-2">
                       <div className="flex justify-between items-center px-1">
                          <span className="text-[9px] font-black text-gray-300 uppercase tracking-[0.2em]">Project Velocity</span>
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="max-w-xl">
             <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="text-xl font-black text-white uppercase tracking-[0.2em] font-display">Data Synchronization</h4>
             </div>
          ...
          <Button className="bg-white text-gray-900 hover:bg-teal-50 rounded-2xl h-16 px-12 font-black uppercase tracking-[0.2em] shadow-2xl shadow-black/20 transition-all hover:scale-105 active:scale-95 border-0 text-[11px] font-display shrink-0">
...
function MetricCard({ label, value, icon: Icon, color, children }) {
  ...
  return (
    <div className="p-5 rounded-3xl bg-white border border-gray-100 shadow-sm hover:shadow-md transition-all flex flex-col items-center group/metric text-center">
      ...
      <p className="text-[9px] font-black text-gray-300 uppercase tracking-widest mb-1.5">{label}</p>
