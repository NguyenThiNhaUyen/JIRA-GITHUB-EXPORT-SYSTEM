...
export function GroupCreationPanel({
 ...
 <label className="text-[10px] font-black text-gray-400 tracking-[0.2em] px-1">Đề tài dự án</label>
 <InputField 
 ...
 <label className="text-[10px] font-black text-gray-400 tracking-[0.2em]">Chọn sinh viên</label>
 <span className="text-[10px] font-black text-teal-600 bg-teal-50 px-2 py-1 rounded-lg border border-teal-100">{selectedStudents.length} Đã chọn</span>
 </div>
 ...
 <p className="text-[10px] font-black text-gray-300 leading-relaxed">Tất cả sinh viên lớp học<br/>đã được phân bổ vào các nhóm</p>
 </div>
 ...
 <div className="space-y-3">
 <label className="text-[10px] font-black text-gray-400 tracking-[0.2em] px-1">Cấu hình Quy mô Nhóm</label>
 <SelectField 
 value={autoGroupSize} 
