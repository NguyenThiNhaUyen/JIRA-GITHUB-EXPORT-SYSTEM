    ...
    return (
      <Card className="border border-gray-100 shadow-sm rounded-[32px] overflow-hidden bg-white">
        ...
        <CardContent className="p-8 flex items-center justify-center min-h-[300px]">
          <div className="text-center text-gray-300 font-bold uppercase tracking-widest text-xs">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="p-4 rounded-2xl border border-gray-100">
              <p className="text-[9px] font-black text-gray-400 uppercase mb-1">Score</p>
              <p className="text-xl font-black text-gray-800">{selectedAlert.metrics?.score || 0}</p>
            </div>
            <div className="p-4 rounded-2xl border border-gray-100">
              <p className="text-[9px] font-black text-gray-400 uppercase mb-1">Thời điểm</p>
              <p className="text-[10px] font-black text-gray-800 uppercase mt-2">
