        ...
        <CardContent className="p-0 flex-1 overflow-y-auto custom-scrollbar">
          {isLoading ? (
            <div className="p-32 text-center space-y-4">
              ...
              <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest animate-pulse">Đang đồng bộ dữ liệu cảnh báo...</p>
            </div>
          ) : (
            <div className="divide-y divide-gray-50">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-4 mb-4">
                        ...
                        <div className="flex items-center gap-2 bg-white border border-gray-100 px-3 py-1.5 rounded-xl shadow-sm">
                          ...
                          <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none">{a.courseCode}</span>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-4">
                        ...
                        {remindedIds.has(a.id) && (
                          <div className="bg-blue-600 text-white px-5 py-2 rounded-2xl text-[9px] font-black uppercase tracking-widest shadow-lg shadow-blue-100 animate-in zoom-in-95">
                            Đã nhắc nhở
                          </div>
                        )}
                      </div>
                    ...
                    {a.status !== 'RESOLVED' && (
                      <div className="flex flex-col justify-center gap-3 shrink-0">
                        <Button
                          variant="outline"
                          className="h-12 px-6 rounded-2xl text-[10px] font-black uppercase tracking-widest border-gray-100 bg-white hover:border-teal-200 hover:text-teal-600 shadow-sm transition-all active:scale-95"
                        ...
                        <Button
                          className="h-12 px-6 rounded-2xl text-[10px] font-black uppercase tracking-widest bg-gray-900 hover:bg-black text-white border-0 shadow-lg shadow-black/10 transition-all active:scale-95"
              ...
              {filtered.length === 0 && (
                <div className="p-32 text-center">
                  ...
                  <p className="text-[10px] font-black text-gray-300 uppercase tracking-[0.2em] leading-relaxed">Hệ thống hiện không ghi nhận<br />cảnh báo nào cần xử lý.</p>
                </div>
              )}
            </div>
          )}
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-2 bg-gray-50/80 border border-gray-100 rounded-2xl transition-all hover:bg-white hover:shadow-md hover:border-teal-100 cursor-default group/badge">
      ...
      <div className="flex flex-col justify-center">
        <span className="text-[8px] font-black text-gray-300 uppercase tracking-widest leading-none mb-1">{label}</span>
