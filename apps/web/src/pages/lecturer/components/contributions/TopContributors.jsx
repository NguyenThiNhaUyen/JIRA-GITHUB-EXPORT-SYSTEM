...
export function TopContributors({ students }) {
 ...
 <h3 className="text-sm font-black text-gray-800 leading-none">Top Contributors</h3>
 ...
 <p className="text-[10px] font-black text-teal-600">{s.team || s.groupName}</p>
 </div>
 </div>
 <div className="text-right">
 <p className="text-sm font-black text-gray-800">{s.commits}</p>
 <p className="text-[9px] font-black text-gray-400">Commits</p>
 </div>
 </div>
 ))}
