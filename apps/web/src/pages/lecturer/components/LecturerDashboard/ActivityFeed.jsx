...
export function ActivityFeed({ activities, loadingLogs }) {
 ...
 <p className="text-sm font-black text-gray-800 leading-snug tracking-tight group-hover:text-teal-700 transition-colors -first">{act.msg}</p>
 <div className="flex items-center gap-4 mt-2">
 <p className="text-[10px] text-gray-400 flex items-center gap-1 font-bold bg-gray-50 px-2 py-0.5 rounded-lg border border-gray-100 group-hover:bg-white group-hover:border-teal-100 transition-colors">
