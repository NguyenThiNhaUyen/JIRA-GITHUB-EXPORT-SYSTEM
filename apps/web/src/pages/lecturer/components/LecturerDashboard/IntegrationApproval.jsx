...
export function IntegrationApproval({ pendingIntegrations, handleApprovePending }) {
 ...
 <CardTitle className="text-sm font-black text-gray-800 leading-none">Phê duyệt Link</CardTitle>
 </div>
 </CardHeader>
 ...
 <button onClick={() => handleApprovePending(g.id)} className="shrink-0 text-[10px] font-black text-teal-600 hover:underline">Duyệt</button>
 </div>
 )}
