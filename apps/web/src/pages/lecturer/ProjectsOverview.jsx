...
export default function ProjectsOverview() {
 ...
 className={`shrink-0 px-5 py-2.5 rounded-xl text-[10px] font-black transition-all border ${statusFilter === f.id ? 'bg-teal-600 text-white border-teal-600 shadow-lg shadow-teal-100' : 'bg-white text-gray-400 border-gray-100 hover:border-teal-400 hover:text-teal-600'
 }`}
 >
 {f.label}
 </button>
