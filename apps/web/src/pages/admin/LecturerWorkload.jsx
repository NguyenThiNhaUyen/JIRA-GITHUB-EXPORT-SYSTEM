...
export default function LecturerWorkload() {
 ...
 <div className="w-10 h-10 rounded-2xl bg-teal-50 text-teal-600 flex items-center justify-center font-black text-xs shadow-sm">
 {item.name?.charAt(0)}
 </div>
 <div>
 <p className="font-black text-gray-800 tracking-tight text-sm">{item.name}</p>
 ...
 <span key={code} className="px-2 py-0.5 bg-gray-100 text-[9px] font-black text-gray-400 rounded-md border border-gray-200">
 {code}
 </span>
 ))}
