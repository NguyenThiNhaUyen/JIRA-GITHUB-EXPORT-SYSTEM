...
export default function SemesterManagement() {
 ...
 <span className="text-[10px] font-bold text-gray-400 tracking-tighter">{formatDisplayDate(s.startDate)} — {formatDisplayDate(s.endDate)}</span>
 </div>
 ...
 <CardTitle className="text-base font-black text-gray-800 leading-none">Danh sách Chi tiết</CardTitle>
 ...
 <TableHead className="py-5 px-8 text-[10px] font-black text-gray-400">Học kỳ</TableHead>
 <TableHead className="py-5 px-8 text-[10px] font-black text-gray-400 text-center">Thời gian</TableHead>
 <TableHead className="py-5 px-8 text-[10px] font-black text-gray-400 text-center">Lớp môn học</TableHead>
 <TableHead className="py-5 px-8 text-[10px] font-black text-gray-400 text-center">Trạng thái</TableHead>
 <TableHead className="py-5 px-8 text-[10px] font-black text-gray-400 text-right">Thao tác</TableHead>
 </TableRow>
 </TableHeader>
 ...
 <p className="text-[10px] font-black text-gray-300">Không tìm thấy học kỳ khả dụng</p>
 </TableCell>
 </TableRow>
 )}
 </TableBody>
 ...
 <p className="text-[10px] font-black text-teal-600 mb-1">Dự kiến tên học kỳ</p>
 ...
 <Button type="button" variant="outline" onClick={() => setShowModal(false)} className="rounded-2xl h-11 px-6 font-bold text-[10px]">Hủy bỏ</Button>
