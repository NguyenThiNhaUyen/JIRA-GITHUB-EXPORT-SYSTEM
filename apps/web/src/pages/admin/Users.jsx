...
export default function UserManagement() {
 ...
 className={`text-[9px] font-black px-4 py-2.5 rounded-xl border transition-all ${filterRole === r
 ...
 <div className={`w-10 h-10 rounded-2xl flex items-center justify-center text-white text-xs font-black shadow-md shadow-gray-200 transition-transform group-hover:scale-110 ${
 ...
 <p className="text-[10px] text-gray-400 font-bold mt-1.5">{u.email}</p>
 </div>
 </div>
 </td>
 ...
 <Badge 
 variant="outline"
 className={`px-3 py-1 rounded-xl font-black text-[9px] border transition-all ${
 ...
 <td className="py-5 px-8 text-center">
 {isActive ? (
 <span className="inline-flex items-center gap-1.5 text-[10px] font-black text-emerald-600 bg-emerald-50 px-3 py-1.5 rounded-full border border-emerald-100 transition-all hover:bg-emerald-100">
 <CheckCircle size={10} /> Active
 </span>
 ) : (
 <span className="inline-flex items-center gap-1.5 text-[10px] font-black text-red-500 bg-red-50 px-3 py-1.5 rounded-full border border-red-100 transition-all hover:bg-red-100">
 ...
 <span className="text-[11px] font-black tracking-wide">Reset Pass</span>
 </button>
 </div>
 </div>
 )}
