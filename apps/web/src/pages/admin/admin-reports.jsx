...
// Charts (Mock components if they don't exist, but we should use the existing ones)
  ...
  const handleGenerateReport = async (type, id) => {
    try {
      ...
      if (type === 'COMMIT') {
        ...
        params = { courseId: id }; // Note: roster can be by course too
      } else if (type === 'SRS') {
    ...
    return (
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="text-center">
          ...
          <p className="text-gray-500 font-medium font-bold uppercase tracking-widest text-xs">Phân tích dữ liệu...</p>
        </div>
      </div>
    );
  }
