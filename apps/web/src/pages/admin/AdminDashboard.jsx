...
export default function AdminDashboard() {
 ...
 <CardTitle className="text-sm font-bold text-gray-700">Hoạt động hệ thống</CardTitle>
 </div>
 </CardHeader>
 ...
 <CardTitle className="text-sm font-bold text-gray-700">Thao tác nhanh</CardTitle>
 </div>
 </CardHeader>
 ...
 <CardTitle className="text-sm font-bold text-gray-700">Lớp học phần gần đây</CardTitle>
 {courseError && (
 ...
 <th className="px-8 py-4 text-xs font-bold text-gray-400 border-b border-gray-100/50">Mã lớp</th>
 <th className="px-8 py-4 text-xs font-bold text-gray-400 border-b border-gray-100/50 text-center">Môn / Học kỳ</th>
 <th className="px-8 py-4 text-xs font-bold text-gray-400 border-b border-gray-100/50 text-center">Sĩ số</th>
 <th className="px-8 py-4 text-xs font-bold text-gray-400 border-b border-gray-100/50 text-center">Trạng thái</th>
 </tr>
 </thead>
 ...
 <div>
 <p className="font-bold text-gray-800 text-sm tracking-tight">{course.code}</p>
