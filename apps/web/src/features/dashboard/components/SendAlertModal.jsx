...
export function SendAlertModal({ isOpen, onClose, groups = [], initialGroupId ="" }) {
 ...
 <label className="text-[10px] font-black text-gray-400 ml-1">Chọn nhóm dự án</label>
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-black text-gray-400 ml-1">Mức độ cảnh báo</label>
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-black text-gray-400 ml-1">Nội dung thông báo</label>
 <textarea
 rows={5}
 value={message}
 ...
 <Button onClick={onClose} variant="ghost" className="rounded-2xl h-12 px-8 font-black text-[10px] text-gray-400">Hủy</Button>
 <Button
