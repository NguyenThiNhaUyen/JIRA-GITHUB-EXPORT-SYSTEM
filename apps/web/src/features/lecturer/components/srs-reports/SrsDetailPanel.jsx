...
export function SrsDetailPanel({ 
 ...
 <div className="group">
 <label className="text-[10px] font-bold text-gray-400 mb-1.5 block">Nhóm & Leader</label>
 <div className="flex items-center gap-3">
 ...
 <div>
 <label className="text-[9px] font-bold text-gray-400 mb-1 block">Môn học</label>
 ...
 <div>
 <label className="text-[9px] font-bold text-gray-400 mb-1 block">Dự án</label>
 ...
 <div>
 <label className="text-[10px] font-bold text-gray-400 mb-2 block">Tài liệu đính kèm</label>
 ...
 <h4 className="text-xs font-black text-gray-800">Phản hồi của giảng viên</h4>
 </div>
 ...
 <Button
 disabled={isUpdating}
 className="rounded-xl h-12 bg-teal-600 hover:bg-teal-700 text-white border-0 shadow-lg shadow-teal-100 text-xs font-black tracking-wider"
 ...
 disabled={isUpdating}
 variant="outline"
 className="rounded-xl h-12 bg-white border-red-100 text-red-600 hover:bg-red-50 text-xs font-black tracking-wider"
