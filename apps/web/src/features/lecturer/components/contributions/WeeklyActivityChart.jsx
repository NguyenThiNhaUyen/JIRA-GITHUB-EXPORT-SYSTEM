    ...
    <Card className="border border-gray-100 shadow-sm rounded-[24px] overflow-hidden bg-white">
      <CardHeader className="border-b border-gray-50 pb-4 px-6">
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="text-base font-black text-gray-800">Hoáº¡t Ä‘á»™ng 12 tuáº§n</CardTitle>
        </div>
      </CardHeader>
      <CardContent className="p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mt-6">
          <div className="p-3 rounded-2xl bg-gray-50 border border-gray-100">
            <p className="text-[9px] font-black text-gray-400">Trung bĂ¬nh</p>
            <p className="text-sm font-black text-gray-700">{avg} commits/tuáº§n</p>
          </div>
          <div className="p-3 rounded-2xl bg-gray-50 border border-gray-100">
            <p className="text-[9px] font-black text-gray-400">Tá»•ng cá»™ng</p>
