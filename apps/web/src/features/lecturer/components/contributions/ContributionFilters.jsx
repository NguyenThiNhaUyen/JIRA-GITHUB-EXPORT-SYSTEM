...
export function ContributionFilters({ search, setSearch, statusFilter, setStatusFilter, activeTab, setActiveTab }) {
  const tabs = [
    ...
    { id: "groups", label: "NhĂ³m" },
    { id: "alerts", label: "Cáº£nh bĂ¡o" },
  ];
      ...
      <div className="flex p-1 bg-gray-50 rounded-2xl w-fit">
        {tabs.map((tab) => (
          <button
            ...
            className={`px-5 py-2 rounded-xl text-xs font-black transition-all ${activeTab === tab.id
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative group">
          ...
          <input
            ...
            placeholder="TĂ¬m tĂªn, MSSV, nhĂ³m..."
        ...
        {activeTab === "students" && (
          ...
          >
            ...
            <option value="TĂ­ch cá»±c">TĂ­ch cá»±c</option>
            <option value="Cáº§n chĂº Ă½">Cáº§n chĂº Ă½</option>
            <option value="KĂ©m">KĂ©m</option>
          </select>
        )}
      </div>
    </div>
