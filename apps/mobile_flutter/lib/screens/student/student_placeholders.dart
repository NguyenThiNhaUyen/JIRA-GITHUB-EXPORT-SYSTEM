...
const List<Map<String, dynamic>> _mockCourses = [
  {
    ...
    "room": "BE-204",
    "description": "Môn học tập trung vào quy trình phát triển phần mềm, quản lý nhóm và tài liệu dự án.",
  },
  {
    "id": "SWD392",
    "code": "SWD392.SP25",
    ...
    "room": "DE-302",
    "description": "Môn project thực hành theo nhóm, kết hợp quản lý task và demo sprint định kỳ.",
  },
  {
    "id": "PRU211",
    "code": "PRU211.SP25",
    ...
    "room": "AL-107",
    "description": "Môn lập trình với C#, hướng đối tượng, xử lý dữ liệu và ứng dụng desktop/web cơ bản.",
  },
];
...
const List<Map<String, dynamic>> _mockProjects = [
  {
    ...
    "course": {"name": "Software Engineering", "subject": {"code": "SE113"}},
    "team": [
  ...
  },
  {
    ...
    "course": {"name": "SWP Project", "subject": {"code": "SWD392"}},
    "team": [
      {"studentId": "SE123456", "studentName": "Trần Thị B"},
  ...
  },
  {
    ...
    "jiraProjectKey": "LIB",
    "teamLeaderId": "SE123456",
    "course": {"name": "C# Programming", "subject": {"code": "PRU211"}},
    "team": [
      {"studentId": "SE123456", "studentName": "Trần Thị B"},
...
const List<Map<String, dynamic>> _mockAlerts = [
  {
    ...
    "message": "Contribution tuần này của bạn thấp hơn tuần trước. Hãy cập nhật task Jira và push tiến độ mới.",
  },
  {
    "id": "A2",
    "severity": "medium",
